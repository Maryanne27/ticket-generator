...
function Page() {
  ...
  return (
    <div className="lg-w-[700px] md-w-[700px] w-375 mx-auto p-8 bg-darkBlue rounded-lg shadow-xl border border-bgBlue ">
      ...
      <div className="pt-4 text-center">
        ...
        <div
          className="relative w-[300px] h-[670px] mt-6 mx-auto"
          ref={ticketRef}
        >
          <Image
            src={ticket}
